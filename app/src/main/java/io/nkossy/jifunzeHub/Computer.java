...
public class Computer extends SQLiteOpenHelper {
    ...
    private static final String Database_path = "/data/data/io.nkossy.collapsingtoolbar/databases/";
    private static final String Database_name = "databases/computer.db";//NAME of database stored in Assets folder
    ...
    //Check whether the db file exists or not
