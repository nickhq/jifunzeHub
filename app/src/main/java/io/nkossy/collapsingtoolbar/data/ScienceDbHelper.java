...
public class ScienceDbHelper {

    private SQLiteOpenHelper openHelper;
    private SQLiteDatabase database;
    private static ScienceDbHelper instance;
    ...
    private ScienceDbHelper(Context context){
     ...
     */
    public static ScienceDbHelper getInstance(Context context) {
        if (instance == null) {
            instance = new ScienceDbHelper(context);
        }
        return instance;
    }
