...
public class MathDbHelper {

    private SQLiteOpenHelper openHelper;
    private SQLiteDatabase database;
    private static MathDbHelper instance;
    ...
    private static final String DB_NAME = "maths.db";

    private MathDbHelper(Context context){
     ...
     */
    public static MathDbHelper getInstance(Context context) {
        if (instance == null) {
            instance = new MathDbHelper(context);
        }
        return instance;
    }
